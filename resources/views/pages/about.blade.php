          ...
          <div class="container">
            ...
            <div class="row off1">
              <div class="grid_6">
                ...
                <h3>What we offer</h3>
                <div class="row">
                  <div data-wow-delay="0.2s" class="grid_3 wow fadeInLeft"><img src="{{ URL::asset('images/page-2_img01.jpg') }}" alt=""></div>
                  <div class="grid_3 wow fadeInLeft"><img src="{{ URL::asset('images/page-2_img02.jpg') }}" alt=""></div>
                </div>
              ...
              <div class="grid_6">
                <h3>Our staff</h3>
                <div class="row">
                  <div class="grid_2 wow fadeInRight"><img src="{{ URL::asset('images/page-2_img03.jpg') }}" alt=""><img src="{{ URL::asset('images/page-2_img06.jpg') }}" alt=""></div>
                  <div data-wow-delay="0.2s" class="grid_2 wow fadeInRight"><img src="{{ URL::asset('images/page-2_img04.jpg') }}" alt=""><img src="{{ URL::asset('images/page-2_img07.jpg') }}" alt=""></div>
                  <div data-wow-delay="0.4s" class="grid_2 wow fadeInRight"><img src="{{ URL::asset('images/page-2_img05.jpg') }}" alt=""><img src="{{ URL::asset('images/page-2_img08.jpg') }}" alt=""></div>
                </div>
